...
class MainMenuState extends MusicBeatState
{
	...
	public static var weirdEngineVersion:String = '0.1.0'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Weird Engine v" + weirdEngineVersion + ' (PE ${psychEngineVersion})', 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat(Paths.font(ThemeLoader.fontName), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
